...
export class ProblemDetails {
    public args: ProblemDetailsProps;

    constructor(args: ProblemDetailsProps) {
        this.args = args;
    }
...
export const isProblemDetails = (
    toBeDetermined: any | ProblemDetails
): toBeDetermined is ProblemDetails => {
    // check if the object is an instance of ProblemDetails
    return toBeDetermined instanceof ProblemDetails;
};